...
export default function BookCover(props: BookCoverProps) {
  ...
  if (props.decorative === true) {
    return (
      <div
        aria-hidden="true"
      className="relative shrink-0 snap-start w-8 h-48 lg:w-14 lg:h-64 animate-slide-up"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Cover content */}
        <div className="absolute inset-0 flex flex-col justify-between p-3 pl-4 lg:p-5 lg:pl-6">
          {/* Top accent line */}
          <div
            className="h-[2px] w-8 lg:w-12 rounded-full"
            style={{ backgroundColor: accentColor }}
          />
          ...
          <div className="flex-1 flex flex-col justify-center">
            <span
              className="text-sm font-bold leading-tight tracking-wide lg:text-lg"
            ...
            {subtitle && (
              <p
                className="mt-1.5 text-[11px] leading-snug tracking-wide lg:text-sm"
          ...
          {/* Bottom accent */}
          <div
            className="h-[2px] w-6 lg:w-8 rounded-full opacity-50"
            style={{ backgroundColor: accentColor }}
          />
        </div>
